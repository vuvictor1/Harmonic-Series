Program that computes the harmonic summation. Features a cpu clock speed reader, with periodic output to represent loading. Additionally, harmonic series keeps track of 
